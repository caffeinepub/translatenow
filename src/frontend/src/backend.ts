...
export class Backend implements backendInterface {
    ...
    async getRecentTranslations(): Promise<Array<Translation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentTranslations();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async translate(arg0: string, arg1: string, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.translate(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
